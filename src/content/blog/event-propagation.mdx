...
description: 'Event propagation is a powerful'
pubDate: 'Jul 02 2022'
...
<div class="node" id="top-node">
	...
	<div class="node" id="mid-node">
		Mid Node
		<a class="node" id="bottom-node" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
			Bottom Node
		</a>
	</div>
</div> 
...
<div class="example-1">
  <div class="node-1" id="top-node-1">
    ...
    <div class="node-1" id="mid-node-1">
      Mid Node
      <a class="node-1" id="bottom-node-1" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
        Bottom Node
      </a>
    </div>
  </div>
...
<div class='example-2'>
	<div class="node-2" id="top-node-2">
		...
		<div class="node-2" id="mid-node-2">
			Mid Node
			<a class="node-2" id="bottom-node-2" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
				Bottom Node
			</a>
		</div>
	</div> 
...
```html
<div class="node" id="top-node">
	Top Node <div class="node" id="mid-node">
		Mid Node
		<a class="node" id="bottom-node" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
			Bottom Node
		</a>
...
<div class='example-3'>
	<div class="node-3" id="top-node-3">
		...
		<div class="node-3" id="mid-node-3">
			Mid Node
			<a class="node-3" id="bottom-node-3" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
				Bottom Node
			</a>
		</div>
	</div>
...
<div class='example-5'>
	<div class="node-5" id="top-node-5">
		...
		<div class="node-5" id="mid-node-5">
			Mid Node
			<a class="node-5" id="bottom-node-5" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
				Bottom Node
			</a>
		</div>
	</div>
...
<div class='example-6'>
	<div class="node-6" id="top-node-6">
		...
		<div class="node-6" id="mid-node-6">
			Mid Node
			<a class="node-6" id="bottom-node-6" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
				Bottom Node
			</a>
		</div>
	</div>
...
<div class='example-7'>
	<div class="node-7" id="top-node-7">
		...
		<div class="node-7" id="mid-node-7">
			Mid Node
			<a class="node-7" id="bottom-node-7" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
				Bottom Node
			</a>
		</div>
	</div>
...
<div class='movies-example'>
	...
	<ul class="list">
		<li class='list-item-1'>
			<span>Game of Thrones</span>
			<button class='movie-button-1' type="submit">Check</button>
		</li>
		<li class='list-item-1'>
			<span>Daredevil</span>
			<button class='movie-button-1' type="submit">Check</button>
...
<div class='movies-example'>
	...
	<ul class="list">
		<li class='list-item-2'>
			<span>Game of Thrones</span>
			<button class='movie-button-2' type="submit">Check</button>
		</li>
		<li class='list-item-2'>
			<span>Daredevil</span>
			<button class='movie-button-2' type="submit">Check</button>
...
<div class="modal">
	...
	<button class='modal-button-1' type="button">Modal</button>
...
<div class="modal">
	<p>Click the button to open the modal</p>
	<button class='modal-button-2' type="button">Modal</button>
